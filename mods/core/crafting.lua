...
function AW.Craft.register_2x2_any_corner_any_orientation(output, m)
  local seen, variants = {}, {
...
----------------------------
-- Example 2x2 mattock recipe
----------------------------
-- Pattern:
-- Pebble Pebble
-- Stick PlantFiber
--[[
	AW.Craft.register_2x2_any_corner_any_orientation("tools:rudimentary_mattock", {
